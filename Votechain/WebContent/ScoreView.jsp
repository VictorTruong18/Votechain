...
<html>
<head>
	<title>Votechain - Election Presidentielle Score</title>
	<meta charset="UTF-8">
	...
	<div class="limiter">
		<div class="container-login100">
			<div class="wrap-login100 p-t-50 p-b-90">
					...
					<h3>Nombre de voix : <%=resultat.get(2) %></h3>
					...
					<h3>Nombre de voix : <%=resultat.get(0) %></h3>
					...
					<h3>Nombre de voix : <%=resultat.get(1) %></h3>
